...
reg = load('../model_training/regression_model.pkl')  # Linear Regression
lgb = load('../model_training/lightgbm_model.pkl')  # LightGBM
cat = load('../model_training/catboost_model.pkl')  # CatBoost
encoder = load('../model_training/mestimate_encoder.pkl')  # Encoder đã lưu
xgb_model = load('../model_training/xgboost_model.pkl')  # XGBoost
