package com.tdtu.logistics_inventory_service.service.client.fallback;
...
public class WarehouseServiceFallback implements WarehouseServiceFeignClient {
	...
	@Override
	public ApiResponse<WarehouseInfResponse> updateCapacity(Long id, double volume, double weight) {
		return null;
	}
}
