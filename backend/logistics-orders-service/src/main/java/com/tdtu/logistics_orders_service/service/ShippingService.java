...
public class ShippingService {
	...
	public BigDecimal calculateShippingCost(ShippingRequestDTO requestDTO) {
		Optional<ShippingRate> shippingRate = shippingRateRepository
				.findShippingRateByServiceTypeAndShippingZoneAndTransportationType(
						requestDTO.getServiceType(),
						requestDTO.getShippingZone(),
						requestDTO.getTransportationType());

		log.info("Service type: {}  , Shipping zone: {} , Transportation type: {}",
				requestDTO.getServiceType(), requestDTO.getShippingZone(), requestDTO.getTransportationType());
