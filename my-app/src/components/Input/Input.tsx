...
export default function Input<TFieldValues extends FieldValues>({
  ...
  register,
  rules,
  classNameInput = 'p-3 w-full outline-none focus:border-gray-500 rounded-sm focus:shadow-sm',
  classNameError = 'mt-1 text-red-600 min-h-[1.25rem] text-sm',
  classNameEye = 'absolute right-0 top-1/2 -translate-y-1/2 cursor-pointer w-5 h-5',
  ...rest
}: Props<TFieldValues>) {
